...
public class MostrarSuporte extends javax.swing.JFrame {

    public MostrarSuporte() {
        initComponents();
    ...
    private void initComponents() {
        ...
        txtproduto1.setForeground(new java.awt.Color(255, 255, 255));
        ...
        txtsolucao1.setForeground(new java.awt.Color(255, 255, 255));
        ...
        txtobjnegocio1.setForeground(new java.awt.Color(255, 255, 255));
        ...
        txcnpj1.setForeground(new java.awt.Color(255, 255, 255));
        ...
        jPanel3.add(jLabel7);
        jLabel7.setBounds(-120, 0, 1280, 720);
        ...
        jEscopo.add(jLabel5);
        jLabel5.setBounds(130, 340, 195, 29);
        ...
        btnactualizar.setBounds(520, 470, 123, 40);
        ...
        jEscopo.add(jLabel6);
        jLabel6.setBounds(130, 430, 225, 29);
        ...
        jLabel12.setBounds(550, 350, 49, 29);
        jEscopo.add(jTextField3);
        jTextField3.setBounds(460, 160, 240, 30);
        ...
        jLabelEstruturaDados.setBounds(410, 127, 310, 20);
        ...
        jTextField1.setBounds(470, 160, 210, 30);
        ...
        btnactualizar2.setFont(new java.awt.Font("Tahoma", 0, 24)); // NOI18N
        ...
        btnactualizar2.setBounds(280, 500, 97, 40);
        ...
        jTextField2.setBounds(440, 450, 190, 30);
        ...
        jSpinnerFreq.setBounds(280, 350, 80, 30);
        ...
        jComboBox5.setBounds(370, 350, 180, 30);
        jBronze.add(jTextField7frequencia);
        jTextField7frequencia.setBounds(280, 310, 170, 30);
        ...
        jSpinnerVol.setBounds(280, 260, 90, 30);
        ...
        jBoxFormato.setBounds(280, 180, 180, 30);
        ...
        jBoxOrigem.setBounds(280, 90, 180, 30);
        ...
        jButton4.setBounds(940, 10, 90, 25);
        ...
        jButton5.setBounds(460, 10, 80, 25);

        btnactualizar3.setFont(new java.awt.Font("Tahoma", 0, 24)); // NOI18N
        ...
        btnactualizar3.setBounds(790, 440, 123, 40);
        ...
        jRadioMatching.setFont(new java.awt.Font("Georgia", 0, 24)); // NOI18N
        jRadioMatching.setForeground(new java.awt.Color(255, 255, 255));
        ...
        jRadioMatching.setBounds(460, 120, 200, 60);

        buttonGroup1.add(jRadioJoin);
        jRadioJoin.setFont(new java.awt.Font("Georgia", 0, 24)); // NOI18N
        jRadioJoin.setForeground(new java.awt.Color(255, 255, 255));
        ...
        jRadioJoin.setBounds(660, 120, 170, 60);

        buttonGroup1.add(jRadioAgregacao);
        jRadioAgregacao.setFont(new java.awt.Font("Georgia", 0, 24)); // NOI18N
        jRadioAgregacao.setForeground(new java.awt.Color(255, 255, 255));
        ...
        jRadioAgregacao.setBounds(830, 120, 200, 60);

        buttonGroup1.add(jRadioSerieTemporal);
        jRadioSerieTemporal.setFont(new java.awt.Font("Georgia", 0, 24)); // NOI18N
        jRadioSerieTemporal.setForeground(new java.awt.Color(255, 255, 255));
        ...
        jRadioSerieTemporal.setBounds(1030, 120, 240, 60);

        jLabelChoice.setFont(new java.awt.Font("Georgia", 0, 24)); // NOI18N
        jLabelChoice.setForeground(new java.awt.Color(255, 255, 255));
        ...
        jEditar3.setBounds(460, 40, 80, 25);
    ...
    private void jMenu1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jMenu1MouseClicked
        ...
        InicioSuporte in = new InicioSuporte();
        in.setVisible(true);
        dispose();
    ...
    private void btnactualizarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnactualizarActionPerformed
        ...
        objcrud.atualizar(objvar.getNome_empresa(), objvar.getObjetivo_neg(), objvar.getEntregavel_min(), objvar.getEntregaveis_possi(), objvar.getSolucao(), objvar.getProduto(), objvar.getFuncionalidade(), objvar.getCore(), objvar.getEstrutura(), objvar.getCnpj());
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        // TODO add your handling code here:
        MostrarSuporte et = new MostrarSuporte();
        et.setVisible(true);
        dispose();
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
        // TODO add your handling code here:
        crudsql crud = new crudsql();
        crud.mostrarGoldTable(txcnpj1.getText());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MostrarSuporte.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new MostrarSuporte().setVisible(true);
            }
        });
    }
