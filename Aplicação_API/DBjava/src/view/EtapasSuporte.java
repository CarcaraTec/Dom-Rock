 ...
 * @author DELL
 */
public class EtapasSuporte extends javax.swing.JFrame {
    

    /**
     * Creates new form Etapas
     */
    public EtapasSuporte() {
        initComponents();
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            ...
            Logger.getLogger(EtapasSuporte.class.getName()).log(Level.SEVERE, null, ex);
        }
        }
        try {
            Connection conexao = new Conexao().getConnection();
    ...
    private void jMenu2MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jMenu2MouseClicked
        if(jEscopo.isShowing()){
            ...
            InicioSuporte vi = new InicioSuporte();
            vi.setVisible(true);
            dispose();
        }
    ...
    private void jButton7ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton7ActionPerformed
        ...
        try {
            ...
            InicioSuporte id = new InicioSuporte();
            id.setVisible(true);
            dispose();
        } catch (SQLException ex) {
            Logger.getLogger(EtapasSuporte.class.getName()).log(Level.SEVERE, null, ex);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(EtapasSuporte.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(() -> {
            new EtapasSuporte().setVisible(true);
        });
    }
